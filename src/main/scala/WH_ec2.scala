...
object WH_ec2 {
	val SPARK_MASTER = "spark://ec2-52-34-184-160.us-west-2.compute.amazonaws.com:7077"
    val HDFS = "hdfs://ec2-52-34-184-160.us-west-2.compute.amazonaws.com:9000"
...
def main(args: Array[String]) {
        ...
        val data = sc
            .textFile("whitehouse-waves-2013.csv",8)
